...
const covf20200323 = x => -1.63397322274e-3*Math.pow(x, 4)+0.115004075249*Math.pow(x,3)-0.927070788174*Math.pow(x,2)+0.811539293526*x+6.4224384359

const covfFunctions = {
  '2020-03-10': covf20200310,
  '2020-03-11': covf20200311,
  '2020-03-12': covf20200312,
  '2020-03-23': covf20200323,
}
let fnName = '2020-03-23'
